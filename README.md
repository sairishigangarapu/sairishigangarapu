...
| :--- | :--- | :--- |
| [**♟️ Distributed Chess**](https://github.com/sairishigangarapu/Distributed-Chess-Platform) | **Real-Time Multiplayer Engine**<br>Architected a high-concurrency gaming platform featuring **sub-50ms latency**, Pub/Sub spectator mode, and persistent state management via WebSockets. | `Node.js` `Socket.io` `MongoDB` `Redis` |
...
![NLTK](https://img.shields.io/badge/NLTK-2D93AD?style=flat-square&logo=python&logoColor=white)
